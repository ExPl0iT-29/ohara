...
Defines the read-side HTTP API for retrieving captured content: fetching a single content item by id, and listing content items with pagination and filtering by status and content type.
