...
## Purpose
Lets the user export their whole library as a portable JSON file and import it back — the backup mechanism, and also the PC-to-mobile link sync path, now that there's no shared backend database.
