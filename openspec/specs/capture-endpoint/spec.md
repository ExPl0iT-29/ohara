...
Defines the capture endpoint that accepts a URL and creates a new `Content` entity in `pending` status, without performing any extraction, enrichment, or AI processing at capture time.
