...
## Purpose
Provides the baseline Expo/React Native mobile app shell for Ohara: project scaffold, typed API client against the backend capture/reader endpoints, React Query data hooks, and a minimal navigation shell (home/feed + reader placeholder screens) for future feature work to build on.
