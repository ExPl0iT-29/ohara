...
Full-text search over saved content (title, extracted text, summary, author, url, topics), ranked by relevance, using PostgreSQL FTS. Semantic/vector search (pgvector) is deferred per STACK.md.
